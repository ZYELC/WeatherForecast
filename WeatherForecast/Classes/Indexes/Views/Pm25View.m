...
{
    // 城市名
    _cityNameLabel = [ZDMView createLabelWithFrame:CGRectMake(0, 20, SCREEN_WIDTH, 25) text:@"未知" font:FONT(22) textColor:COLOR_BLACKCOLOR];
    _cityNameLabel.textAlignment = NSTextAlignmentCenter;
    [self addSubview:_cityNameLabel];
    
    // 空气质量指数
    UILabel *indexesLabel = [ZDMView createLabelWithFrame:CGRectMake(0, _cityNameLabel.maxY + 5, SCREEN_WIDTH, 15) text:@"空气质量指数" font:FONT(12) textColor:COLOR_LIGHTGRAYCOLOR];
    indexesLabel.textAlignment = NSTextAlignmentCenter;
    [self addSubview:indexesLabel];
    
    // 空气
    _airIndexesLabel = [ZDMView createLabelWithFrame:CGRectMake(0, 0, 200, 80) text:@"" font:FONT(80) textColor:_viewColor];
    ...
    // 质量
    _qualityLabel = [ZDMView createLabelWithFrame:CGRectMake(0, 0, 50, 25) text:@"N/A" font:FONT(25) textColor:COLOR_BLACKCOLOR];
    ...
    UILabel *pm25Label = [ZDMView createLabelWithFrame:CGRectMake(_qualityLabel.x - pmLabelWidth, _qualityLabel.maxY + 10, pmLabelWidth, 15) text:@"pm2.5" font:FONT(12) textColor:COLOR_LIGHTGRAYCOLOR];
    pm25Label.textAlignment = NSTextAlignmentCenter;
    [self addSubview:pm25Label];
    
    // pm2.5的数值
    _pm25IndexesLabel = [ZDMView createLabelWithFrame:CGRectMake(pm25Label.x , pm25Label.maxY , pmLabelWidth, 15) text:@"N/A" font:FONT(12) textColor:COLOR_LIGHTGRAYCOLOR];
    ...
    // pm10 title
    UILabel *pm10Label = [ZDMView createLabelWithFrame:CGRectMake(_qualityLabel.maxX , _qualityLabel.maxY + 10, pmLabelWidth, 15) text:@"pm10" font:FONT(12) textColor:COLOR_LIGHTGRAYCOLOR];
    pm10Label.textAlignment = NSTextAlignmentCenter;
    [self addSubview:pm10Label];
    
    // pm10的数值
    _pm10IndexesLabel = [ZDMView createLabelWithFrame:CGRectMake(pm10Label.x , pm10Label.maxY , pmLabelWidth, 15) text:@"N/A" font:FONT(12) textColor:COLOR_LIGHTGRAYCOLOR];
    ...
    // 空气级别
    _cityRankLabel = [ZDMView createLabelWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 20) text:@"" font:FONT(18) textColor:COLOR_LIGHTGRAYCOLOR];
...
//ld: '/Users/Tsa/Desktop/“天气+”项目/WeatherForecast/WeatherForecast/libs/UMSocial_Sdk_4.2.3/libUMSocial_Sdk_4.2.3.a(UMSocialData.o)' does not contain bitcode. You must rebuild it with bitcode enabled (Xcode setting ENABLE_BITCODE), obtain an updated library from the vendor, or disable bitcode for this target. for architecture arm64
