...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _nameLabel = [ZDMView createLabelWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 40) text:@"未知" font:FONT(20) textColor:COLOR_WHITECOLOR];
        _nameLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:_nameLabel];
        
        _tempLabel = [ZDMView createLabelWithFrame:CGRectMake(0, _nameLabel.maxY + 10, SCREEN_WIDTH, 80) text:@"N/A" font:FONT(80) textColor:COLOR_WHITECOLOR];
        ...
        _weatherLabel = [ZDMView createLabelWithFrame:CGRectMake(_weatherIcon.maxX + 10 , _weatherIcon.center.y, SCREEN_WIDTH / 2 - 20, 20) text:@"没有网络数据" font:FONT(15) textColor:COLOR_WHITECOLOR];
...
//    CGContextSetLineJoin(context, kCGLineJoinMiter);
    ...
    // 绘制坐标轴到坐标的虚线条
    const CGFloat lengths[] = {2, 2};//虚线点的长度，虚线间隔的长度
