...
#define UMengAppkey @"54dda2f6fd98c5ec680008aa"
...
//    self.window.rootViewController = [[UINavigationController alloc]  initWithRootViewController:[[WeatherViewController alloc] init]];
    ...
    NSString *saveVersion = [ZDMTool objectForKey:@"saveVersion"];
    ...
    else
    {
        ...
        [ZDMTool setObject:currentVersion forKey:@"saveVersion"];
    }
...
- (void)gotoIntroductionScrollView{
    ...
    for (int i=0; i<imageCount; i++) {
        ...
        if (i == imageCount - 1) {
            ...
            btn.layer.borderColor = COLOR_BLACKCOLOR.CGColor;
...
- (void)gotoWeatherViewController{
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.window.rootViewController = [[CustomViewController alloc] initWithRootViewController:root];
    }];
}
